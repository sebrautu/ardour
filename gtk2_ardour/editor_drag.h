...
{
public:
	RegionInsertDrag (Editor *, std::shared_ptr<ARDOUR::Region>, RouteTimeAxisView*, Temporal::timepos_t const &);
...
private:
	...
	std::list<std::shared_ptr<ARDOUR::Region> > _orig_tav_ripples;
};
