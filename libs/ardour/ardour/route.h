...
public:
	 ...
	 */
	bool feeds (std::shared_ptr<Route>, bool* via_send_only = 0);
	 ...
	 */
	bool direct_feeds_according_to_reality (std::shared_ptr<Route>, bool* via_send_only = 0);
	...
	bool feeds_according_to_graph (std::shared_ptr<Route>);
	...
	struct FeedRecord {
		...
		FeedRecord (std::shared_ptr<Route> rp, bool sendsonly)
		: r (rp)
	...
	void clear_fed_by ();
	bool add_fed_by (std::shared_ptr<Route>, bool sends_only);
