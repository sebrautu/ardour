...
private:
	...
	*/
	...
	void maybe_copy_midifiles (snapshot_t, std::shared_ptr<Source> src, XMLNode*);
	...
	*/
	...
	SessionEvent* get_rt_event (std::shared_ptr<ControlList> cl, double arg, PBD::Controllable::GroupControlDisposition group_override) {
		SessionEvent* ev = new SessionEvent (SessionEvent::RealTimeOperation, SessionEvent::Add, SessionEvent::Immediate, 0, 0.0);
	...
	void rt_set_controls (std::shared_ptr<ControlList>, double val, PBD::Controllable::GroupControlDisposition group_override);
